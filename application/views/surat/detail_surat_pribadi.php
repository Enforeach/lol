        ...
        <div class="main-panel">
                                                ...
                                                <div class="card-body">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="hidden" name="id_detail" class="form-control" readonly="" value="<?= $surat->id_detail ?>" placeholder="contoh: PT. Induk Jaya">
                                                                        <input type="text" name="tempat" class="form-control" readonly="" value="<?= $surat->tempat ?>" placeholder="contoh: Malang" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group date">
                                                                        <input type="text" id="basicDate" name="tanggal" value="<?= $surat->tgl ?>" class="form-control" readonly=""
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" name="nama_tujuan" class="form-control" readonly="" value="<?= $surat->nama_tujuan ?>" placeholder="contoh: Kakak Desi">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" name="kota_tujuan" class="form-control" readonly="" value="<?= $surat->kota_tujuan ?>" placeholder="contoh: Malang">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" name="salam_pembuka" class="form-control" readonly="" value="<?= $surat->salam_pembuka ?>" placeholder="contoh: Salam kangen">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                <div class="form-group">
                                                                    <label for="" class="control-label"><b><u>Isi Surat</u></b></label><br>
                                                                    <div class="col-md-12">
                                                                        <div class="row">
                                                                            <div class="col-md-9">
                                                                                <!-- <button type="button" class="btn btn-warning" id="tambaha" disabled=""><i class="fa fa-plus"></i>Paragraf</button>
                                                                                <button type="button" class="btn btn-warning" id="tambahlist" disabled=""><i class="fa fa-plus"></i>List</button> -->
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        <?php  
                                                                    ...
                                                                    foreach ($isi as $key) { 
                                                                        if ($key->jenis == "par") { 
                                                                            ...
                                                                            <div id="lala<?=$no?>">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-9">
                                                                                        <textarea type="text" name="isi<?=$no?>" id="isi<?=$no?>" onblur="lololo('isi<?=$no?>');" class="form-control" readonly="" value=""><?=$key->isi?></textarea>
                                                                                    </div>

                                                                                    <input type="hidden" id="pantau<?=$no?>" class="form-control" readonly="" value="<?=$key->jenis?>">
                                                                        ...
                                                                        <?php } if (count($isi) == $no) { ?>
                                                                            <!-- <div style="margin-top: 20px;" id="lp">
                                                                                <button type="button" class="btn btn-danger" disabled="" id="hapusa<?= $no ?>" onclick="pus('hapusa<?= $no ?>');"><i class="fa fa-trash"></i></button>
                                                                            </div> -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div>
                                                                        <input type="text" name="salam_penutup" class="form-control" readonly="" value="<?= $surat->salam_penutup ?>" placeholder="contoh: Adik tercintamu">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="hidden" id="ln" value="<?= count($isi) ?>">
                                                                    <div>
                                                                        <input type="text" name="nama" placeholder="contoh: Lala" value="<?= $surat->nama ?>" class="form-control" readonly="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-12 mt-5">
                                                           ...
                                                           <input type="hidden" name="cek" id="cek">
                                                            ...
                                                            <a href="<?= site_url('Create/cetak_Pribadi/'.$surat->id_detail) ?>" target="_blank" class="btn btn-primary pull-right">Cetak</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
           ...
           <script type="text/javascript">
                ...
                $('#tambaha').click(function(){
                    ...
                    Baris += '<div class="row">';
                    Baris += '<div class="col-md-9">';
                    Baris += '<textarea type="text" name="isi'+line+'" id="isi'+line+'" onblur="lololo(\'isi\'+line);" class="form-control" readonly="" value=""> </textarea>';
                    Baris += '</div>';

                    Baris += '<input type="hidden" id="pantau'+line+'" class="form-control" readonly="" value="para">';
                ...
                $('#tambahlist').click(function(){
                    ...
                    Baris += '<input type="hidden" id="pantau'+line+'" class="form-control" readonly="" value="li">';
                    Baris += '<div class="col-md-3" id="place'+line+'">';
                    Baris += '<div id="trash'+line+'">';
                    Baris += '<button type="button" class="btn btn-danger" id="hapusa'+line+'" onclick="pus(\'hapusa\'+line);"><i class="fa fa-trash"></i></button>';
                    Baris += '</div>';
