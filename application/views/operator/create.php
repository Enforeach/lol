                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <?php if (!$edit) { ?>
                                                          ...
                                                          cursor: pointer;"/>
                                                      <?php }else { ?>
                                                        <img id="profileImage" width="210" height="210" src="<?= site_url("images/operator/".$FOTO) ?>" alt=""
                                                        style="display: block;
                                                        border: 1px solid gray;
                                                        margin-left: auto;
                                                        margin-right: auto; 
                                                        ...
                                                        border-radius: 50%;
                                                        cursor: pointer;
                                                        background-image: url('https://i.ibb.co/qxHR5SM/tidakadaphoto.jpg');
                                                        background-size: 210px 210px;
                                                        "/>
                                                    <?php } ?>
                                                    <div class="file" style="display: none">
                                                        <input type="file" id="imageUpload" accept="image/*" class="uploads form-control" style="margin-top: 20px;" name="FOTO" placeholder="Photo" capture="filesystem">
                                                    </div>
