...
class M_history extends CI_Model
{
  ...
  public function datatableHistoryAll()
  {
    ...
    foreach ($q as $val) {
      ...
      <a href="'.site_url('Side/edit_surat_All/'.$val->id_detail).'" class="btn btn-info btn-xs" style="text-align: center; width: 37px;" data-toggle="tooltip" title="Edit Surat"><i class="mdi mdi-pencil"></i></a>
  ...
  public function datatableHistoryPribadi()
  {
    ...
    foreach ($q as $val) {
      ...
      $btn = ' <a href="'.site_url('Side/detail_surat_pribadi/'.$val->id_detail).'" class="btn btn-primary btn-xs" style="text-align: center; width: 37px;" data-toggle="tooltip" title="Lihat & Cetak"><i class="mdi mdi-eye"></i></a>
