...
<head>
  ...
  <script src="<?= site_url('assets/custom.js'); ?>"></script>
    ...
    font-size: 12px !important;
      ...
      @media (min-width: 1200px){
        ...
        .no-photo{
            ...
            object-fit: cover;
            display: block;
            background: url('https://scontent-sin6-2.xx.fbcdn.net/v/t1.0-9/88071639_1418006338377986_4975427743618433024_n.jpg?_nc_cat=109&_nc_sid=8024bb&_nc_ohc=6dDxjcNhEIwAX-8VrfX&_nc_ht=scontent-sin6-2.xx&oh=a27ce54cf064e60401fd2f7712cdd5b6&oe=5EA50479');
        }
